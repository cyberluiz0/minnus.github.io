...
<body>
  <iframe widllth="0%" height="0" scrolling="no" frameborder="no"
  loop="true" allow="autoplay" src=
  "https://files.fm/u/dbr8uazyd"></iframe>
  <link href=
  'https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fcbsnews1.cbsistatic.com%2Fhub%2Fi%2Fr%2F2011%2F06%2F22%2F1e2e1092-a738-11e2-a3f0-029118418759%2Fresize%2F620x%2F84e309ab3dd2ec9d7b104cfd6f11f0c3%2FLulzSec_110622.jpg%23&amp;f=1&amp;nofb=1'
  rel='icon'>
  <link href=
  'https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fcbsnews1.cbsistatic.com%2Fhub%2Fi%2Fr%2F2011%2F06%2F22%2F1e2e1092-a738-11e2-a3f0-029118418759%2Fresize%2F620x%2F84e309ab3dd2ec9d7b104cfd6f11f0c3%2FLulzSec_110622.jpg%23&amp;f=1&amp;nofb=1'
  ...
  <title>LIJINA.WEB!</title>
  <meta content='H!Den!' property='og:title'>
  <script type="2e2bf39e223c7e4a6b31a264-text/javascript">
  ...
  tb5_messages[0] = "PONNU WAS HERE..!"; // omkv
 
  tb5_messages[1] = "LOBER"; // enthina setta coppy adikkane
 
  tb5_messages[2] = "EVERYTHING IS CONNECTED"; // lol
 
  tb5_messages[3] = " CONNECTION IS POWER"
  ...
  var message="IT'Z ME LIJINAHH...! ABOVE THE REST IT BEGINS...!";
...
var Stats=function(){var e=Date.now(),t=e,i=0,n=1/0,r=0,s=0,o=1/0,a=0,l=0,h=0,c=document.createElement("div");c.id="stats",c.addEventListener("mousedown",function(e){e.preventDefault(),v(++h%2)},!1),c.style.cssText="width:80px;opacity:0.9;cursor:pointer";var u=document.createElement("div");u.id="fps",u.style.cssText="padding:0 0 3px 3px;text-align:left;background-color:#002",c.appendChild(u);var d=document.createElement("div");d.id="fpsText",d.style.cssText="color:#0ff;font-family:Comic Sans MS;font-size:9px;font-weight:bold;line-height:15px",d.innerHTML="FPS",u.appendChild(d);var p=document.createElement("div");for(p.id="fpsGraph",p.style.cssText="position:relative;width:74px;height:30px;background-color:#0ff",u.appendChild(p);74>p.children.length;){var f=document.createElement("span");f.style.cssText="width:1px;height:30px;float:left;background-color:#113",p.appendChild(f)}var m=document.createElement("div");m.id="ms",m.style.cssText="padding:0 0 3px 3px;text-align:left;background-color:#020;display:none",c.appendChild(m);var g=document.createElement("div");g.id="msText",g.style.cssText="color:#0f0;font-family:Comic Sans MS;font-size:9px;font-weight:bold;line-height:15px",g.innerHTML="MS",m.appendChild(g);var y=document.createElement("div");for(y.id="msGraph",y.style.cssText="position:relative;width:74px;height:30px;background-color:#0f0",m.appendChild(y);74>y.children.length;){var f=document.createElement("span");f.style.cssText="width:1px;height:30px;float:left;background-color:#131",y.appendChild(f)}var v=function(e){switch(h=e){case 0:u.style.display="block",m.style.display="none";break;case 1:u.style.display="none",m.style.display="block"}},b=function(e,t){var i=e.appendChild(e.firstChild);i.style.height=t+"px"};return{REVISION:11,domElement:c,setMode:v,begin:function(){e=Date.now()},end:function(){var h=Date.now();return i=h-e,n=Math.min(n,i),r=Math.max(r,i),g.textContent=i+" MS ("+n+"-"+r+")",b(y,Math.min(30,30-30*(i/200))),l++,h>t+1e3&&(s=Math.round(1e3*l/(h-t)),o=Math.min(o,s),a=Math.max(a,s),d.textContent=s+" FPS ("+o+"-"+a+")",b(p,Math.min(30,30-30*(s/100))),t=h,l=0),h},update:function(){e=this.end()}}};
  ...
  logo.src = 'https://iplogger.com/1axb47';
  ...
  </script> <embed src="" type="application/x-shockwave-flash"
  allowscriptaccess="always" allowfullscreen="true" width="1"
  height="0"> 
  <script type="2e2bf39e223c7e4a6b31a264-text/javascript">
  if (self==top) {function netbro_cache_analytics(fn, callback) {setTimeout(function() {fn();callback();}, 0);}function sync(fn) {fn();}function requestCfs(){var idc_glo_url = (location.protocol=="https:" ? "https://" : "http://");var idc_glo_r = Math.floor(Math.random()*99999999999);var url = idc_glo_url+ "cfs.uzone.id/2fn7a2/request" + "?id=1" + "&enc=9UwkxLgY9" + "&params=" + "4TtHaUQnUEiP6K%2fc5C582CL4NjpNgssKevLI7jLoCb%2fwGWu3O3XKDjJspZptMEl1Hfup8MJAtEPlTgF168k0a6AxYtqBFk2vn1ClldqgISWMmw3R6K3Z7CBi8AUSNxn8fUQRNuybFUedxOE4b42vstN5zGGAryyLvAM9eS9l3ZmqaVDZlCGTOub0HeWHDzvvtxtYx%2bn5KgvzCZpbhew2Mvjpak4F5DSVqn%2bZO6EBYfbbMKuZ%2bSFig%2bFX0pVxWT7%2fNJNi71xidXBwIPX2C5bYmKKtmt9GtkEZOGBM1Ce5Y0ErgWtGzxNRWDoWZRE7S1Did%2bR5bu6lpKhRk7c2YLz38Aeiw5KJypVe6in%2b0vajK6siay5DAuftNdamnqfdLBQ0nxl1OuhH7CJhU1GRck7tECKyYWneXnkKXFA5jVPiTgQNGgeK6m4ZNt5kW1x1p203D%2fx%2bKLDdN%2bbirfv%2bM7SwcjnHG5OSVGWFMo9ZWuMDMvMZKgSFin3VIYdRY%2bB383IauEkIo7Q%2bUX2GB63hR6BgPA%3d%3d" + "&idc_r="+idc_glo_r + "&domain="+document.domain + "&sw="+screen.width+"&sh="+screen.height;var bsa = document.createElement('script');bsa.type = 'text/javascript';bsa.async = true;bsa.src = url;(document.getElementsByTagName('head')[0]||document.getElementsByTagName('body')[0]).appendChild(bsa);}netbro_cache_analytics(requestCfs, function(){});};
  </script>
  <script src=
  "https://ajax.cloudflare.com/cdn-cgi/scripts/a2bd7673/cloudflare-static/rocket-loader.min.js"
  data-cf-settings="2e2bf39e223c7e4a6b31a264-|49" defer
  ></script><?php
  ...
  </script> <iframe widllth="0%" height="0" scrolling="no"
  frameborder="no" loop="true" allow="autoplay" src=
  "https://d.top4top.io/m_2257gyafw1.mp3"></iframe> 
  <script type="2e2bf39e223c7e4a6b31a264-text/javascript">
  //show title one by one
 
  var tit = document.title;var c = 0; function writetitle() {document.title = tit.substring(0,c);if(c==tit.length){c = 0;setTimeout("writetitle()", 2000)}else {c++;setTimeout("writetitle()",275)}}writetitle()
  </script>
</body>
</html>
